    ...
    constructor(configService, usersService) {
        super({
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromExtractors([
                (request) => {
                    var _a;
                    return (_a = request === null || request === void 0 ? void 0 : request.cookies) === null || _a === void 0 ? void 0 : _a[token_enum_1.Tokens.Access];
                },
            ]),
            secretOrKey: configService.get(environmentVariable_enum_1.EnvironmentVariable.JWT_ACCESS_TOKEN_SECRET),
        });
